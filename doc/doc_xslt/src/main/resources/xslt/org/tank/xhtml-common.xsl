...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
  ...
  <xsl:param name="siteHref" select="'http://www.intuit.com'"/>
  <xsl:param name="docHref" select="'http://docs.intuit.com/'"/>
  <xsl:param name="siteLinkText" select="'Intuit'"/>
  ...
  <xsl:param name="html.stylesheet" select="'/resources/css/tank.css'"/>
