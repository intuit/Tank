...
public class ControllerInitiatedAgentWsClientTest {
    ...
    void testSessionCloseClearsTerminationDedup() throws Exception {
        ...
        installSession(client, "i-agent", webSocket);
        invokeOnClosed(client, "i-agent", webSocket);
        invokeHandleStatusUpdate(client, "i-agent", statusUpdate);
    ...
    private void invokeOnClosed(ControllerInitiatedAgentWsClient client, String instanceId, WebSocket webSocket) throws Exception {
        Method method = ControllerInitiatedAgentWsClient.class.getDeclaredMethod(
                "onClosed", String.class, WebSocket.class);
        method.setAccessible(true);
        method.invoke(client, instanceId, webSocket);
    }

    @SuppressWarnings("unchecked")
    private void installSession(ControllerInitiatedAgentWsClient client, String instanceId, WebSocket webSocket) throws Exception {
        ...
        Constructor<?> constructor = sessionContextClass.getDeclaredConstructor(WebSocket.class, CompletableFuture.class);
        constructor.setAccessible(true);
        Object sessionContext = constructor.newInstance(webSocket, new CompletableFuture<AgentWsEnvelope>());
