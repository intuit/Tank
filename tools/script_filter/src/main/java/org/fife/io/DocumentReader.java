...
public class DocumentReader extends Reader {
    ...
    /**
     * Marks the present position in the stream. Subsequent calls to <code>reset()</code> will reposition the stream to
     * this point.
     * 
    ...
    /**
     * Tells whether this reader supports the <code>mark</code> operation. This always returns <code>true</code> for
    ...
    /**
     * Read <code>array.length</code> characters from the beginning of the document into <code>array</code>.
     * 
     * @param array
     ...
     * @return The number of characters read, or <code>-1</code> if the end of the stream (document) has been reached.
     */
    ...
    /**
     * Tells whether this reader is ready to be read without blocking for input. <code>DocumentReader</code> will always
     * return true.
     * 
    ...
    /**
     * Move to the specified position in the document. If <code>pos</code> is greater than the document's length, the
