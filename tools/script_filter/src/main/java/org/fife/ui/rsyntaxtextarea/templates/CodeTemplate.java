...
/**
 * A "code template" is a kind of macro for commonly-typed code. It associates a short identifier with a longer code
 * snippet, then when the code template is enabled and the short identifier is typed, it is replaced with the longer
 * code snippet.
 * <p>
 * 
 ...
 * <p>
 * 
 * Static text replacements are done with {@link StaticCodeTemplate}. Dynamic templates can also be created and used.
 * 
