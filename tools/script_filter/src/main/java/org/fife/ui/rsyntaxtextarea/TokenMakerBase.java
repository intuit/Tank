...
abstract class TokenMakerBase implements TokenMaker {
     ...
     * <p>
     * 
     * The default implementation returns <code>false</code>; subclasses can override this method if necessary.
     * 
    ...
    /**
     * Returns an action to handle "insert break" key presses (i.e. Enter). The default implementation returns
     * <code>null</code>. Subclasses can override.
     * 
     ...
     * language. The default implementation returns true if <tt>type</tt> is {@link Token#IDENTIFIER}. Subclasses can
     * override this method to support other token types, such as {@link Token#VARIABLE}.
     * 
     * @param type
     *            The token type.
    ...
    /**
     * The default implementation returns <code>false</code> always. Languages that wish to better support
     * auto-indentation can override this method.
     * 
     * @param token
    ...
    /**
     * The default implementation returns <code>false</code> always. Subclasses that are highlighting a markup language
    ...
    /**
     * Deletes the linked list of tokens so we can begin anew. This should never have to be called by the programmer, as
     * it is automatically called whenever the user calls {@link #getLastTokenTypeOnLine(Segment, int)} or
