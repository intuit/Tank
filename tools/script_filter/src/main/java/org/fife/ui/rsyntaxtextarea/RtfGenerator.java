...
public class RtfGenerator {
     ...
     *            The text to append.
     * @param f
     *            The font of the text. If this is <code>null</code>, the default font is used.
     * @param fg
     *            The foreground of the text. If this is <code>null</code>, the default foreground color is used.
     * @param bg
     *            The background color of the text. If this is <code>null</code>, the default background color is used.
     * @see #appendNewline()
     */
     ...
     *            Whether the text should be underlined.
     * @param setFG
     *            Whether the foreground specified by <code>fg</code> should be honored (if it is non-<code>null</code>
     *            ).
     * @see #appendNewline()
     */
    public void appendToDoc(String text, Font f, Color fg, Color bg,
     ...
     * 
     * @param pointSize
     *            A Java Font's point size, as returned from <code>getSize2D()</code>.
