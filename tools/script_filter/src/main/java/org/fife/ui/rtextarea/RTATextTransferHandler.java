...
/**
 * Handles the transfer of data to/from an <code>RTextArea</code> via drag-and-drop. This class is pretty much ripped
 * off from a subclass of <code>BasicTextUI</code>. In the future, it will include the ability to drag-and-drop files
 * into <code>RTextArea</code>s (i.e., the text will be inserted into the text area).
 * <p>
 * 
...
public class RTATextTransferHandler extends TransferHandler {
    ...
    /**
     * Try to find a flavor that can be used to import a Transferable to a specified text component. The set of usable
     * flavors are tried in the following order:
     * <ol>
     * <li>First, an attempt is made to find a flavor matching the content tyep of the EditorKit for the component.
     ...
     * @param c
     *            The text component to see whether it will accept any of the specified data flavors as input.
     */
    ...
    /**
     * This is the type of transfer actions supported by the source. Some models are not mutable, so a transfer
     * operation of COPY only should be advertised in that case.
     * 
     * @param c
     ...
     * @return If the text component is editable, COPY_OR_MOVE is returned, otherwise just COPY is allowed.
     */
    ...
    /**
     * This method is called after data has been exported. This method should remove the data that was transfered if the
     * action was MOVE.
     * 
     * @param source
    ...
    /**
     * This method indicates if a component would accept an import of the given set of data flavors prior to actually
