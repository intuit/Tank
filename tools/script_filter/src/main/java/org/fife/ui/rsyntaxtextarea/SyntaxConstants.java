...
/**
 * Constants that define the different programming languages understood by <code>RSyntaxTextArea</code>. These constants
 * are the values you can pass to {@link RSyntaxTextArea#setSyntaxEditingStyle(String)} to get syntax highlighting.
 * <p>
 * 
 * By default, all <code>RSyntaxTextArea</code>s can render all of these languages, but this can be changed (the list
 ...
 * <code>RSyntaxDocumenet</code>s have a factory installed capable of handling all of these languages.
 * 
