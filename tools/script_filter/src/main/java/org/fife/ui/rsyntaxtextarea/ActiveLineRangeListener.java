...
/**
 * Listens for "active line range" events from an <code>RSyntaxTextArea</code>. If a text area contains some semantic
 ...
 * <p>
 * 
 * See the <code>RSTALanguageSupport</code> project at <a href="http://fifesoft.com">http://fifesoft.com</a> for some
 * <code>LanguageSupport</code> implementations that may broadcast these events. Note that if an RSTA/LanguageSupport
...
public interface ActiveLineRangeListener extends EventListener {
     ...
     *            and "maximum" line values should both be <code>-1</code>.
     */
