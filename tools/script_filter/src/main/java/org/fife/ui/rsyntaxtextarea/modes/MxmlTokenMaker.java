 ...
 * <ul>
 * <li>The generated <code>MXMLTokenMaker.java</code> file will contain two definitions of both <code>zzRefill</code>
 * and <code>yyreset</code>. You should hand-delete the second of each definition (the ones generated by the lexer), as
...
public class MxmlTokenMaker extends AbstractMarkupTokenMaker {
    ...
    /**
     * Token type specific to this class; this signals that the user has ended a line with an unclosed XML tag; thus a
     * new line is beginning still inside of the tag.
     */
    public static final int INTERNAL_INTAG = -1;

    /**
     * Token type specific to this class; this signals that the user has ended a line with an unclosed Script tag; thus
     * a new line is beginning still inside of the tag.
     */
    public static final int INTERNAL_INTAG_SCRIPT = -2;

    /**
     * Token type specific to this class; this signals that the user has ended a line in the middle of a double-quoted
     * attribute in a Script tag.
     */
    public static final int INTERNAL_ATTR_DOUBLE_QUOTE_SCRIPT = -3;

    /**
     * Token type specific to this class; this signals that the user has ended a line in the middle of a single-quoted
     * attribute in a Script tag.
     */
    public static final int INTERNAL_ATTR_SINGLE_QUOTE_SCRIPT = -4;

    /**
     * Token type specific to this class; this signals that the user has ended a line in an ActionScript code block
     * (text content inside a Script tag).
     */
    public static final int INTERNAL_IN_AS = -5;

    /**
     * Token type specific to this class; this signals that the user has ended a line in an MLC in an ActionScript code
     * block (text content inside a Script tag).
     */
