...
public interface ParserNotice extends Comparable {
     ...
     * @return Whether the position is contained. This will always return <code>false</code> if {@link #getOffset()}
     *         returns <code>-1</code>.
     */
     ...
     * 
     * @return The tool tip text. If none has been explicitly set, this method returns the same text as
     *         {@link #getMessage()}.
     */
