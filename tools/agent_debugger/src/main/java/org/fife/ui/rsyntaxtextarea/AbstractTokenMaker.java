...
/**
 * An abstract implementation of the {@link org.fife.ui.rsyntaxtextarea.TokenMaker} interface. It should be overridden
 * for every language for which you want to provide syntax highlighting.
 * <p>
 * 
 * @see Token
 * 
...
public abstract class AbstractTokenMaker extends TokenMakerBase {
     ...
     * values are the token types, for example, <code>Token.RESERVED_WORD</code> or <code>Token.FUNCTION</code>.
     */
     ...
     * 
     * @return A <code>TokenMap</code> containing the words to highlight for this programming language.
     */
     ...
     * directly; it can be called by subclasses of <code>TokenMaker</code> if necessary.
     */
