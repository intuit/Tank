 ...
 * <p>
 * 
 * A <code>java.awt.image.VolatileImage</code> is used for rendering; theoretically, this should be the best image
...
public class VolatileImageBackgroundPainterStrategy
    ...
    /**
     * Renders the image at the proper size into <code>bgImage</code>. This method assumes that <code>bgImage</code> is
     * not <code>null</code>.
     * 
     * @param width
