...
abstract class AbstractGutterComponent extends JComponent {
    ...
    /**
     * Returns the bounds of a child view as a rectangle, since <code>View</code>s tend to use <code>Shape</code>.
     * 
     * @param parent
     ...
     * @param editorRect
     *            Returned from the text area's <code>getVisibleEditorRect</code> method.
    ...
    /**
     * Called when text is inserted to or removed from the text area. Implementations can take this opportunity to
    ...
    /**
     * Called when the line heights of the text area change. This is usually the result of one or more of the fonts in
     * the editor changing.
     */
