 ...
 * <ul>
 * <li>The generated JSPTokenMaker.java</code> file will contain two definitions of both <code>zzRefill</code> and
...
public class JSPTokenMaker extends AbstractMarkupTokenMaker {
    ...
    /**
     * Token type specific to JSPTokenMaker; this signals that the user has ended a line with an unclosed HTML tag; thus
     * a new line is beginning still inside of the tag.
     */
    public static final int INTERNAL_INTAG = -1;

    /**
     * Token type specific to JSPTokenMaker; this signals that the user has ended a line with an unclosed
