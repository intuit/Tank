...
/**
 * The <code>javax.swing.text.View</code> object used by {@link RSyntaxTextArea} when word wrap is disabled. It
...
public class SyntaxView extends View implements TabExpander,
     ...
     * line that is the longest. The <em>longLine</em> variable is updated to represent the longest line contained. The
     * <em>font</em> variable is updated to indicate the font used to calculate the longest line.
     */
     ...
     * above the line containing <code>offset</code>, since lines are not wrapped.
     * 
     * @param offset
     *            The offset in question.
     * @return A token list for the physical (and in this view, logical) line before this one. If <code>offset</code> is
     *         in the first line in the document, <code>null</code> is returned.
     */
     ...
     * the document. Note that for this plain (non-wrapped) view, this is simply the token list for the logical line
     * below the line containing <code>offset</code>, since lines are not wrapped.
     * 
     * @param offset
     *            The offset in question.
     * @return A token list for the physical (and in this view, logical) line after this one. If <code>offset</code> is
     *         in the last physical line in the document, <code>null</code> is returned.
     */
