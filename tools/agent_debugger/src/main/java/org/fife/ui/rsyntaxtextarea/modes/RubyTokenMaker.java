 ...
 * <ul>
 * <li>The generated RubyTokenMaker.java</code> file will contain two definitions of both <code>zzRefill</code> and
...
public class RubyTokenMaker extends AbstractJFlexTokenMaker {
    ...
    /**
     * Token type specific to RubyTokenMaker; this signals that we are inside an unquoted/double quoted/backtick EOF
     * heredoc.
     */
    ...
    /**
     * Token type specific to RubyTokenMaker; this signals that we are inside an unquoted/double quoted/backtick EOT
     * heredoc.
     */
    ...
    /**
     * Token type specific to RubyTokenMaker; this signals that we are inside a %Q&lt;...&gt; style double quoted
     * string.
     */
