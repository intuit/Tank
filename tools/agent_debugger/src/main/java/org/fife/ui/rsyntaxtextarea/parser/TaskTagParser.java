...
/**
 * Parser that identifies "task tags," such as "<code>TODO</code>", "<code>FIXME</code>", etc. in source code comments.
 * 
...
public class TaskTagParser extends AbstractParser {
    ...
    /**
     * Creates a new task parser. The default parser treats the following identifiers in comments as task definitions: "
     * <code>TODO</code>", "<code>FIXME</code>", and "<code>HACK</code>".
     */
     ...
     * 
     * @return The regular expression. This may be <code>null</code> if no regular expression was specified (or an empty
    ...
    /**
     * Sets the pattern of task identifiers. You will usually want this to be a list of words "or'ed" together, such as
     * "<code>TODO|FIXME|HACK|REMIND</code>".
     * 
     * @param pattern
     *            The pattern. A value of <code>null</code> or an empty string effectively disables task parsing.
