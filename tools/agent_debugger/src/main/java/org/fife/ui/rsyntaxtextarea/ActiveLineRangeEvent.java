...
public class ActiveLineRangeEvent extends EventObject {
     ...
     *            The text area.
     * @param min
     *            The first line in the active line range, or <code>-1</code> if the line range is being cleared.
     * @param max
     *            The last line in the active line range, or <code>-1</code> if the line range is being cleared.
     */
