...
class LineNumberList extends AbstractGutterComponent
    ...
    /**
     * The index at which line numbering should start. The default value is <code>1</code>, but applications can change
     * this if, for example, they are displaying a subset of lines in a file.
     */
    ...
    /**
     * Constructs a new <code>LineNumberList</code> using default values for line number color (gray) and highlighting
     * the current line.
     * 
     * @param textArea
     ...
     *            The text component for which line numbers will be displayed.
     * @param numberColor
     *            The color to use for the line numbers.
     */
    ...
    /**
     * Overridden to set width of this component correctly when we are first displayed (as keying off of the RTextArea
     * gives us (0,0) when it isn't yet displayed.
     */
    ...
    /**
     * Changes the height of the cells in the JList so that they are as tall as font. This function should be called
     * whenever the user changes the Font of <code>textArea</code>.
     */
