...
class SizeGrip extends JPanel {
     ...
     */
    /*
     * NOTE: We use SwingUtilities.convertPointToScreen() instead of just using the locations relative to the corner
     * component because the latter proved buggy - stretch the window too wide and some kind of arithmetic error started
