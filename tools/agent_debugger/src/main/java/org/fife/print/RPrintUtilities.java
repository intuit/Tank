...
public abstract class RPrintUtilities {
    ...
    /**
     * Returns the position closest to, but before, position <code>maxCharsPerLine</code> in <code>line</code> of one of
     * the chars in <code>breakChars</code>, or simply returns <code>maxCharsPerLine-1</code> if none of the
     * <code>breakChars</code> comes before that position. This position represents the logical line break for this
     * <code>java.lang.String</code> if it is being printed in a monospaced font when lines can only be
     * <code>maxCharsPerLine</code> characters long.
     * 
     * @param line
     *            The text being printed.
     * @param maxCharsPerLine
     *            Only up-to this many characters from <code>line</code> can be printed on one line.
     * @return The logical position at which to stop printing <code>line</code> to simulate word wrap.
     */
    ...
    /**
     * Prints a <code>Document</code> using a monospaced font, and does no word wrapping (ie, words will wrap mid-word
     ...
     *            The graphics context to write to.
     * @param textComponent
     *            The <code>javax.swing.text.JTextComponent</code> whose text you're printing.
     * @param font
     *            The font to use for printing. If <code>null</code>, then <code>textComponent</code>'s font is used.
     * @param pageIndex
     *            The page number to print.
     * @param pageFormat
     *            The format to print the page with.
