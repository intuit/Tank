...
import com.intuit.tank.reporting.api.DummyResultsReader;
...
public final class ReportingFactory {
     ...
     * @return
     */
    public static ResultsReporter getResultsReporter() {
        ...
        try {
            ...
            LOG.error("Error instantiating results reporter", e);
            return new DummyResultsReporter();
        }
        return ret;
    }
    /**
     ...
     * @return
     */
    public static ResultsReader getResultsReader() {
        ...
        try {
            ...
            LOG.error("Error instantiating results reader", e);
            return new DummyResultsReader();
        }
        return ret;
    }
