...
public class SimplePathReplacement extends AbstractReplacement {

    public SimplePathReplacement() {
        super(RequestStepSection.simplePath, ScriptConstants.REQUEST);
    }

    @Override
    public List<ReplaceEntity> getReplacements(ScriptStep step, String searchQuery, String replaceString,
            SearchMode searchMode) {
        return getReplacementInValue(searchQuery, replaceString, step.getSimplePath(), step.getType());
    }

    @Override
    public void replace(ScriptStep step, String replaceString, String key, ReplaceMode replaceMode) {
        step.setSimplePath(replaceString);
    }
