...
public class RequestHeaderValueReplacement extends AbstractReplacement {

    public RequestHeaderValueReplacement() {
        super(RequestStepSection.requestHeaderValue, ScriptConstants.REQUEST);
    }
