...
public class LoggingKeyReplacement extends AbstractReplacement {

    public LoggingKeyReplacement() {
        super(RequestStepSection.logginKey, ScriptConstants.REQUEST);
    }

    @Override
    public List<ReplaceEntity> getReplacements(ScriptStep step, String searchQuery, String replaceString,
            SearchMode searchMode) {
        return getReplacementInValue(searchQuery, replaceString, step.getLoggingKey(), step.getType());
    }
