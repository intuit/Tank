...
public class RequestCookieValueReplacement extends AbstractReplacement {

    public RequestCookieValueReplacement() {
        super(RequestStepSection.requestCookieValue, ScriptConstants.REQUEST);
    }
