...
public class VariableValueReplacement extends AbstractReplacement {

    public VariableValueReplacement() {
        super(VariableSection.variableValue, ScriptConstants.VARIABLE);
    }
