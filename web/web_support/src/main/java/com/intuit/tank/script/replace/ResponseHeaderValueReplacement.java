...
public class ResponseHeaderValueReplacement extends AbstractReplacement {

    public ResponseHeaderValueReplacement() {
        super(RequestStepSection.responseHeaderValue, ScriptConstants.REQUEST);
    }
