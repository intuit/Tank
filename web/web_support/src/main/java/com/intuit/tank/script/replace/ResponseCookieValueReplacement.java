...
public class ResponseCookieValueReplacement extends AbstractReplacement {

    public ResponseCookieValueReplacement() {
        super(RequestStepSection.responseCookieKey, ScriptConstants.REQUEST);
    }
