...
import com.intuit.tank.script.replace.QueryStringValueReplacement;
...
/**
 * The class <code>QueryStringValueReplacementTest</code> contains tests for the class <code>{@link QueryStringValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class QueryStringValueReplacementTest {
    /**
     * Run the QueryStringValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testQueryStringValueReplacement_1()
        throws Exception {

        QueryStringValueReplacement result = new QueryStringValueReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        QueryStringValueReplacement fixture = new QueryStringValueReplacement();
