...
import com.intuit.tank.script.replace.MaxTimeReplacement;
...
/**
 * The class <code>MaxTimeReplacementTest</code> contains tests for the class <code>{@link MaxTimeReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class MaxTimeReplacementTest {
    /**
     * Run the MaxTimeReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testMaxTimeReplacement_1()
        throws Exception {

        MaxTimeReplacement result = new MaxTimeReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        MaxTimeReplacement fixture = new MaxTimeReplacement();
     ...
     */
    @Test
    public void testGetReplacements_5()
        throws Exception {
        MaxTimeReplacement fixture = new MaxTimeReplacement();
        ScriptStep step = new ScriptStep();
        String searchQuery = "";
