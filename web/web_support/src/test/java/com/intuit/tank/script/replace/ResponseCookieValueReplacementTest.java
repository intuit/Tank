...
import com.intuit.tank.script.replace.ResponseCookieValueReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>ResponseCookieValueReplacementTest</code> contains tests for the class <code>{@link ResponseCookieValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ResponseCookieValueReplacementTest {
    /**
     * Run the ResponseCookieValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testResponseCookieValueReplacement_1()
        throws Exception {

        ResponseCookieValueReplacement result = new ResponseCookieValueReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ResponseCookieValueReplacement fixture = new ResponseCookieValueReplacement();
