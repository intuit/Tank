...
/**
 * The class <code>HostReplacementTest</code> contains tests for the class <code>{@link HostReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class HostReplacementTest {
    /**
     * Run the HostReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testHostReplacement_1()
        throws Exception {

        HostReplacement result = new HostReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        HostReplacement fixture = new HostReplacement();
