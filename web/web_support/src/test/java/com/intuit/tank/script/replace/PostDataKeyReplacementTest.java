...
import com.intuit.tank.script.replace.PostDataKeyReplacement;
...
/**
 * The class <code>PostDataKeyReplacementTest</code> contains tests for the class <code>{@link PostDataKeyReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class PostDataKeyReplacementTest {
    /**
     * Run the PostDataKeyReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testPostDataKeyReplacement_1()
        throws Exception {

        PostDataKeyReplacement result = new PostDataKeyReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        PostDataKeyReplacement fixture = new PostDataKeyReplacement();
