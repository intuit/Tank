...
import com.intuit.tank.script.replace.ScriptGroupNameReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>ScriptGroupNameReplacementTest</code> contains tests for the class <code>{@link ScriptGroupNameReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ScriptGroupNameReplacementTest {
    /**
     * Run the ScriptGroupNameReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testScriptGroupNameReplacement_1()
        throws Exception {

        ScriptGroupNameReplacement result = new ScriptGroupNameReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ScriptGroupNameReplacement fixture = new ScriptGroupNameReplacement();
