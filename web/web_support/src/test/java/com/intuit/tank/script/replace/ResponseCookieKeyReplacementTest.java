...
import com.intuit.tank.script.replace.ResponseCookieKeyReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>ResponseCookieKeyReplacementTest</code> contains tests for the class <code>{@link ResponseCookieKeyReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ResponseCookieKeyReplacementTest {
    /**
     * Run the ResponseCookieKeyReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testResponseCookieKeyReplacement_1()
        throws Exception {

        ResponseCookieKeyReplacement result = new ResponseCookieKeyReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ResponseCookieKeyReplacement fixture = new ResponseCookieKeyReplacement();
