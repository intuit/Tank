...
import com.intuit.tank.script.replace.ProtocolReplacement;
...
/**
 * The class <code>ProtocolReplacementTest</code> contains tests for the class <code>{@link ProtocolReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ProtocolReplacementTest {
    /**
     * Run the ProtocolReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testProtocolReplacement_1()
        throws Exception {

        ProtocolReplacement result = new ProtocolReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ProtocolReplacement fixture = new ProtocolReplacement();
