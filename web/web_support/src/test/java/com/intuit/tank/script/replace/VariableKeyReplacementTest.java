...
import com.intuit.tank.script.replace.VariableKeyReplacement;

/**
 * The class <code>VariableKeyReplacementTest</code> contains tests for the class <code>{@link VariableKeyReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class VariableKeyReplacementTest {
    /**
     * Run the VariableKeyReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testVariableKeyReplacement_1()
        throws Exception {

        VariableKeyReplacement result = new VariableKeyReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        VariableKeyReplacement fixture = new VariableKeyReplacement();
