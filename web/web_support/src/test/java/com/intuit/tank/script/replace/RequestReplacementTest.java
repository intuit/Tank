...
import com.intuit.tank.script.replace.RequestReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>RequestReplacementTest</code> contains tests for the class <code>{@link RequestReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class RequestReplacementTest {
    /**
     * Run the RequestReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testRequestReplacement_1()
        throws Exception {

        RequestReplacement result = new RequestReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        RequestReplacement fixture = new RequestReplacement();
