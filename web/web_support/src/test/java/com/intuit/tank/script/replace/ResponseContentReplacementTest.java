...
import com.intuit.tank.script.replace.ResponseContentReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>ResponseContentReplacementTest</code> contains tests for the class <code>{@link ResponseContentReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ResponseContentReplacementTest {
    /**
     * Run the ResponseContentReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testResponseContentReplacement_1()
        throws Exception {

        ResponseContentReplacement result = new ResponseContentReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ResponseContentReplacement fixture = new ResponseContentReplacement();
