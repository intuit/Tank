...
import com.intuit.tank.script.replace.NameReplacement;
...
/**
 * The class <code>NameReplacementTest</code> contains tests for the class <code>{@link NameReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class NameReplacementTest {
    /**
     * Run the NameReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testNameReplacement_1()
        throws Exception {

        NameReplacement result = new NameReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        NameReplacement fixture = new NameReplacement();
