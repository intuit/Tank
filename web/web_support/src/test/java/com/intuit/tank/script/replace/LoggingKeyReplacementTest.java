...
import com.intuit.tank.script.replace.LoggingKeyReplacement;
...
/**
 * The class <code>LoggingKeyReplacementTest</code> contains tests for the class <code>{@link LoggingKeyReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class LoggingKeyReplacementTest {
    /**
     * Run the LoggingKeyReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testLoggingKeyReplacement_1()
        throws Exception {

        LoggingKeyReplacement result = new LoggingKeyReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        LoggingKeyReplacement fixture = new LoggingKeyReplacement();
