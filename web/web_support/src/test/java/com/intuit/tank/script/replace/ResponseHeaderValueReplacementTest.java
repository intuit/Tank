...
import com.intuit.tank.script.replace.ResponseHeaderValueReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>ResponseHeaderValueReplacementTest</code> contains tests for the class <code>{@link ResponseHeaderValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class ResponseHeaderValueReplacementTest {
    /**
     * Run the ResponseHeaderValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testResponseHeaderValueReplacement_1()
        throws Exception {

        ResponseHeaderValueReplacement result = new ResponseHeaderValueReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        ResponseHeaderValueReplacement fixture = new ResponseHeaderValueReplacement();
