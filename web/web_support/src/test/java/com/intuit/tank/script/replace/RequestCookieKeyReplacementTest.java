...
import com.intuit.tank.script.replace.RequestCookieKeyReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>RequestCookieKeyReplacementTest</code> contains tests for the class <code>{@link RequestCookieKeyReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class RequestCookieKeyReplacementTest {
    /**
     * Run the RequestCookieKeyReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testRequestCookieKeyReplacement_1()
        throws Exception {

        RequestCookieKeyReplacement result = new RequestCookieKeyReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        RequestCookieKeyReplacement fixture = new RequestCookieKeyReplacement();
