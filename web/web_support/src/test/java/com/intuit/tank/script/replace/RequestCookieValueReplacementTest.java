...
import com.intuit.tank.script.replace.RequestCookieValueReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>RequestCookieValueReplacementTest</code> contains tests for the class <code>{@link RequestCookieValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class RequestCookieValueReplacementTest {
    /**
     * Run the RequestCookieValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testRequestCookieValueReplacement_1()
        throws Exception {

        RequestCookieValueReplacement result = new RequestCookieValueReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        RequestCookieValueReplacement fixture = new RequestCookieValueReplacement();
