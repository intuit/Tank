...
import com.intuit.tank.script.replace.VariableValueReplacement;

/**
 * The class <code>VariableValueReplacementTest</code> contains tests for the class <code>{@link VariableValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class VariableValueReplacementTest {
    /**
     * Run the VariableValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testVariableValueReplacement_1()
        throws Exception {

        VariableValueReplacement result = new VariableValueReplacement();

        assertNotNull(result);
        assertEquals("variable", result.getType());
    }
    ...
    public void testGetReplacements_1()
        throws Exception {
        VariableValueReplacement fixture = new VariableValueReplacement();
