...
import com.intuit.tank.script.replace.AllReplacement;
...
/**
 * The class <code>AllReplacementTest</code> contains tests for the class <code>{@link AllReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class AllReplacementTest {
    /**
     ...
     */
    @Test
    public void testAllReplacement_1()
        throws Exception {
