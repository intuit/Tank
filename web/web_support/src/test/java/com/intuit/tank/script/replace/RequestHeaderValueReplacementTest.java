...
import com.intuit.tank.script.replace.RequestHeaderValueReplacement;
import com.intuit.tank.script.replace.SearchMode;

/**
 * The class <code>RequestHeaderValueReplacementTest</code> contains tests for the class <code>{@link RequestHeaderValueReplacement}</code>.
 *
 * @generatedBy CodePro at 12/16/14 6:32 PM
 */
public class RequestHeaderValueReplacementTest {
    /**
     * Run the RequestHeaderValueReplacement() constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 12/16/14 6:32 PM
     */
    @Test
    public void testRequestHeaderValueReplacement_1()
        throws Exception {

        RequestHeaderValueReplacement result = new RequestHeaderValueReplacement();
    ...
    public void testGetReplacements_1()
        throws Exception {
        RequestHeaderValueReplacement fixture = new RequestHeaderValueReplacement();
