...
public class GenericServiceResourceNotFoundException extends GenericServiceException {
     ...
     */
    public GenericServiceResourceNotFoundException(String service, String resource, Throwable cause) {
        super("Error returning " + resource + " caused by " + cause);
