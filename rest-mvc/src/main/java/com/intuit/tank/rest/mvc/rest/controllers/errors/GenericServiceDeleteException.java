...
public class GenericServiceDeleteException extends GenericServiceException {
     ...
     */
    public GenericServiceDeleteException(String service, String resource, Throwable cause) {
        super("Error deleting " + resource + " caused by " + cause);
