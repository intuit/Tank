...
public class DataFileController {
    ...
    @Operation(description = "Uploads a datafile to Tank (supports gzip files) \n\n " +
            "Examples: \n\n" +
            "        curl -v -X POST -H 'Content-Type: multipart/form-data' -H \"Authorization: Bearer <token>\" -F \"file=@<filename>\" 'https://{tank-base-url}/v2/datafiles/upload'\n\n" +
            "\n\n" +
            "        curl -v -X POST -H 'Content-Type: multipart/form-data' -H \"Authorization: Bearer <token>\" -F \"file=@<filename>\" 'https://{tank-base-url}/v2/datafiles/upload?id=<datafileId>'\n\n" +
            "\n\n" +
            "        gzip <filename>\n\n" +
            "        curl -v -X POST -H 'Content-Type: multipart/form-data' -H \"Authorization: Bearer <token>\" -H 'Content-Encoding: gzip' -F \"file=@<filename>.gz\" 'https://{tank-base-url}/v2/datafiles/upload'\n\n" +
            "Notes: \n\n " +
