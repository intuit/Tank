    ...
    public void run() {
        ...
        while (doMonitor) {
            try {
                ...
                LOG.info(LogUtil.getLogMessage("Sending status to controller: " + newStatus));
                LOG.info(LogUtil.getLogMessage("Validation Kills: " + newStatus.getValidationFailures().getValidationKills()));
                LOG.info(LogUtil.getLogMessage("Validation Aborts: " + newStatus.getValidationFailures().getValidationAborts()));
                LOG.info(LogUtil.getLogMessage("Validation Gotos: " + newStatus.getValidationFailures().getValidationGotos()));
                LOG.info(LogUtil.getLogMessage("Validation Skips: " + newStatus.getValidationFailures().getValidationSkips()));
