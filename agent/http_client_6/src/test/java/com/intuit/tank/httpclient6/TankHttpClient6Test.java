...
public class TankHttpClient6Test {

    @Test(groups = TestGroups.FUNCTIONAL)
    public void testBasicAuth() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/basic-auth/test/test_pass");
    ...
    public void doDelete() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/delete");
    ...
    @Test(groups = TestGroups.FUNCTIONAL)
    public void doGet() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/get");
        request.getHttpclient().addAuth(AuthCredentials.builder().withHost("httpbin.org").build());
        request.doGet(null);
        BaseResponse response = request.getResponse();
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getHttpCode());
    ...
    @Test(groups = TestGroups.FUNCTIONAL)
    public void doPost() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/post");
        request.doPost(null);
        BaseResponse response = request.getResponse();
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getHttpCode());
    ...
    @Test(groups = TestGroups.FUNCTIONAL)
    public void doPut() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/put");
        request.doPut(null);
        BaseResponse response = request.getResponse();
        Assert.assertNotNull(response);
        Assert.assertEquals(200, response.getHttpCode());
    ...
    public void clearSession() {
        BaseRequest request = getRequest(new TankHttpClient6(), "http://httpbin.org/cookies");
    ...
    public void testSSL() {
        BaseRequest request = getRequest(new TankHttpClient6(), "https://www.pcwebshop.co.uk/");
        request.doGet(null);
        BaseResponse response = request.getResponse();
        Assert.assertNotNull(response);
    }
