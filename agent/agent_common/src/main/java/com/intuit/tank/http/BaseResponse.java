...
public abstract class BaseResponse {
    ...
    public void logResponse() {
        try {
            ...
            sb.append("RESPONSE HTTP MSG: ").append(this.rspMessage).append(NEWLINE);
            sb.append("RESPONSE TIME: ").append(responseTime).append(NEWLINE);
            sb.append("RESPONSE SIZE: ").append(responseByteArray.length).append(NEWLINE);
            for (Entry<String, String> mapEntry : headers.entrySet()) {
                sb.append("RESPONSE HEADER: ").append((String) mapEntry.getKey()).append(" = ").append((String) mapEntry.getValue()).append(NEWLINE);
            }
